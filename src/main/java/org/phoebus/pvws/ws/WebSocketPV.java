...
public class WebSocketPV
{
    ...
    /** Support writing? */
    private static boolean PV_WRITE_SUPPORT;

    private final String name;
    private final WebSocket socket;
    private volatile PV pv;
    private final AtomicReference<Disposable> subscription = new AtomicReference<>(), array_subscription = new AtomicReference<>(),
    ...
    private static final Logger logger = Logger.getLogger(WebSocketPV.class.getName());
